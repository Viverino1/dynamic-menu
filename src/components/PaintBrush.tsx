...
export default function PaintBrush({
  ...
  return (
    <svg
      ...
      viewBox="0 13.48249027237354 258 58.42412451361867"
    ...
    >
      ...
      <g stroke="none" fill={color} transform="translate(0.000000,77.000000) scale(0.100000,-0.100000)">
        <path
          d="M243 618 c-110 -5 -138 -10 -166 -27 -19 -12 -44 -21 -56 -21 -21 0
